      ...
      <div className="about-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
        ...
        <div className="mt-7 md:mt-10 section-title">
          ...
          <p className="max-w-2xl mt-4 md:mt-6 subtitle">
            Hi, my name is <span className="text-black dark:text-white">Brown Reddick</span> and I began using WordPress when first began. spent most of my waking hours for the last ten years designing, programming and operating <span className="text-black dark:text-white"> WordPress</span> sites go beyond with exclusive designer.
          </p>
        </div>
        <div className="mt-6 section-content">
          ...
          <ul className="grid mt-4 mb-10 text-sm lg:mt-6 md:grid-cols-2 gap-x-8 gap-y-3">
            <li>
              ...
              <span className="text-black dark:text-white">+(2) 870 174 302</span>
            </li>
            <li>
              <span className="flex-[0_0_6rem]">Email</span>
              <span className="flex-[0_0_2rem]">:</span>
              <span className="text-black dark:text-white">info@example.com</span>
            </li>
            <li>
            ...
            <li>
              ...
              <span className="flex-[0_0_2rem]">:</span>
              <span className="text-black dark:text-white">English, Dutch, Spanish</span>
            </li>
          </ul>
